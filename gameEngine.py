...
class GameWorld:
    ...
    def start(self):
        ...
        class Native:
            def updateScreen(screenData):
                if screenData == "default":
                    pass
                else:
                    tableScreen.table_data = screenData
        ...
        class Inventory:
            def discard(partInventory):
                ...
                with open(f'saves/{self.loadName}/{self.loadName}.json', 'w') as saveChanges:
        ...
        while True:
            ...
            #Dev Testsss
                ...
                os.system("cls")
                Native.updateScreen([["Mapa"],[mapData]])
